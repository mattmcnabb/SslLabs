...
Pester\Describe "Manifest" {
    ...
    Pester\It "has a valid guid" {
        $ManifestHash.Guid | Should Be "eecf6029-4e2e-4f0d-a572-e567ecb2c72f"
    }
    ...
    Pester\It 'has a valid project Uri' {
        $ManifestHash.PrivateData.Values.ProjectUri | Should Be "https://github.com/mattmcnabb/SslLabs"
    }
